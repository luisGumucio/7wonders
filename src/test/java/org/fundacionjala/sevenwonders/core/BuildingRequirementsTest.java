...
public class BuildingRequirementsTest {
    ...
    private static final int firstAge = 1;
    ...
    public void setUp() {
        ...
        templeBuilding = new Building(templeRequirements, effects, playersNeeded, firstAge, "Temple", BuildingType.CIVIC);
        gatesBuilding = new Building(gatesRequirements, effects, playersNeeded, firstAge, "Gates of the city", BuildingType.CIVIC);
        bathsBuilding = new Building(bathsRequirements, effects, playersNeeded, firstAge, "Baths", BuildingType.CIVIC);
